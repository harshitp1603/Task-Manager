...
void SystemInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->efficiencyModeChanged((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 2: _t->updateSystemInfo(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SystemInfo::*)()>(_a, &SystemInfo::dataUpdated, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SystemInfo::*)(bool )>(_a, &SystemInfo::efficiencyModeChanged, 1))
            return;
    }
}
...
// SIGNAL 0
void SystemInfo::dataUpdated()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SystemInfo::efficiencyModeChanged(bool _t1)
{
